        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="card maan-card-img">
                        <a class="topcategories-thumb" href="  @if(Route::has(strtolower($newscategory->name))){{ route(strtolower($newscategory->name)) }}@endif">

                        <img src="{{ asset($newscategory->image) }}" alt="{{$newscategory->name}}">

                        </a>
                        <div class="card-body maan-card-body">
                            <a href="  @if(Route::has(strtolower($newscategory->name))){{ route(strtolower($newscategory->name)) }}@endif">
