                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="maan-post-adds">
                            <a href=" @if (advertisement()->leaderboard_url) {{advertisement()->leaderboard_url}} @else https://www.google.com/ @endif " target="_blank">
                                <img src="
@if (advertisement()->leaderboard_image) {{asset(advertisement()->leaderboard_image)}} @else {{ asset('public/frontend/img/post-add/add.jpg') }} @endif " alt="{{ asset('public/frontend/img/post-add/add.jpg') }}">
                            </a>
                        </div>
