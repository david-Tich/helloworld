                ...
                <form method="POST" action="{{ route('admin.social.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="flower">{{ __('Flowers') }}</label>
                                <input type="number" class="form-control" name="flower" id="flower" placeholder="Enter flower" value="{{old('flower')}}" required>
                                @error('flower')
                                <span class="text-danger">
                                    {{$message}}
                                </span>
                ...
                <form id="editformname" method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="edit_flower">{{ __('Flowers') }}</label>
                                <input type="number" class="form-control" name="flower" id="edit_flower" placeholder="Enter flower" value="{{old('flower')}}" required>
                                @error('flower')
                                <span class="text-danger">
                                    {{$message}}
                                </span>
        ...
        $(document).ready(function (){
            ...
            $('.edit-item').each(function () {
                ...
                $('#edit-item_'+service).on('click',function () {
                    ...
                    $('#edit_flower').val($('#edit-item_'+service).data('flower'));
